...
Access the application at `http://localhost:3000` and login with your admin password.
...
# Note: JWT_SECRET is automatically generated by Terraform - no manual setup needed
```

See [terraform/README_AUTH.md](terraform/README_AUTH.md) for detailed authentication setup instructions.
